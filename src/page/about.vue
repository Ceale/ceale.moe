    ...
    <div class="container">
        ...
        <div class="readme">
            ...
            <div style="display: flex; align-items: center;">
                ...
                <span style="margin-left: 1em; transform: translateY(0.3em);">
                    这是我在互联网上活跃时使用的头像，<br>
                    如今它是井芹仁菜小姐。井芹仁菜真的很可爱。
                </span>
            </div>
            <p>
                真的很高兴认识你。如果想多了解我一点，那么可以<a class="button" href="javascript:会随机抽一个标签哦" @click="roll = true">点击这里</a>，查看一个关于我的标签。
                <RollTag :roll @reset="roll = false" style="margin: 0.5em 0;"/>
            </p>
            <p>从下面的社交平台上可以找到我，欢迎在来找我玩！也欢迎给我发邮件。</p>
            <div class="link">
